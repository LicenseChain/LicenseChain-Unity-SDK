...
{
    /// <summary>
    /// Legacy non-v1 compatibility manager for older Unity integrations.
    /// New integrations should use LicenseChain.Unity.LicenseChainApiV1Client.
    /// </summary>
    [Obsolete("LicenseChainManager is a legacy non-v1 surface. Use LicenseChain.Unity.LicenseChainApiV1Client for current API integrations.")]
    public class LicenseChainManager : MonoBehaviour
    {
        private const string LegacyManagerNotice =
            "LicenseChainManager uses legacy non-v1 endpoints. Use LicenseChain.Unity.LicenseChainApiV1Client for supported API v1 integrations.";
        ...
        private void Start()
        {
            Debug.LogWarning($"LicenseChain: {LegacyManagerNotice}");
